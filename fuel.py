...
def MyGetFuel():
	...
	<table>
	<tr><td width=10></td><td width=20 style ="background-color: pink"></td><td width=120>Today</td><td align="Right"  width=220>Average Price for this week is:</td><td width=50 align="Right">$ Price</td></tr>
	<tr><td width=10></td><td width=20 style ="background-color: lime"></td><td width=120>Tomorrow</td><td align="Right"  width=220>Cheapest day this week is:</td><td width=50 align="Right">$ Price</td></tr>
	</table>
	{my_html_list}
	{html_end}
	'''
